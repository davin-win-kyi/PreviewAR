...
def analyze_product_with_rag(html_content):
    ...
    dimension_results = query_rag_for_dimensions(db, html_content)
    
    print("Querying for product image selectors...")
    image_results = query_rag_for_images(db, html_content)
...
def main():
    ...
    # Debug: Show what HTML content we're analyzing
