...
def get_best_image(json_path):
    ...
    sel = selector.get_best_image_from_amazon_json(json_path, args.criteria)
    print(json.dumps({
...
if __name__ == "__main__":
    get_best_image("output\\amazon\\B0FB2PSYPK_20251020-163146.json")
